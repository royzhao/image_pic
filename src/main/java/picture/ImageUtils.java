...
public class ImageUtils {
    ...
    public final static void scale(String srcImageFile, String result,
        ...
        try {
            ...
            float scale = (float)x/(float)width;
...
//            }
    ...
    public final static Point getImgSize(String name){
     ...
     */
    public final static void cut3(String srcImageFile, String descImageName,
            ...
            if (srcWidth >= destWidth && srcHeight >= destHeight) {
                ...
                for (int i = 0; i < 1; i++) {
                    for (int j = 0; j < 1; j++) {
                        ...
                        g.dispose();
                        // 输出为文件
                        ImageIO.write(tag, "JPEG", new File(descImageName));
                    }
                }
            }
        } catch (Exception e) {
    ...
    public final static void pressText2(String pressText, String srcImageFile,String destImageFile,
        ...
        try {
            ...
            g.setColor(color);
//            g.setFont(new Font(fontName, fontStyle, fontSize));
            g.setFont(LoadFont.Font2(fontSize));
//            g.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_ATOP,
//                    alpha));
            // 在指定坐标绘制水印文字
